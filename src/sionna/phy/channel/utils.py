...
def set_3gpp_nearfield_scenario_parameters(scenario,
                                            min_bs_ut_dist=None,
                                            isd=None,
                                            bs_height=None,
                                            min_ut_height=None,
    ...
    r"""
    Set valid parameters for a specified 3GPP system level ``scenario``
    (RMa, UMi, or UMa) in near-field mode
    ...
    assert scenario in ('umi', 'inh-open-office'), \
        "`scenario` must be one of 'umi', 'inh-open-office'"
